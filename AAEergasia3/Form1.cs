...
namespace AAEergasia3
{
    public partial class Form1 : Form
    {
        ...
        private void songsDataGridView_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            {
                if (playing != -1)
                {//reset previous song row colors
        ...
        private void songsDataGridView_CellClick(object sender, DataGridViewCellEventArgs e)
        {
                ...
                "Confirm", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                if (e.RowIndex < playing)
                    playing--;
                else if (e.RowIndex == playing)
        ...
        private void nextBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                next = rand.Next(songsDataGridView.RowCount);
            }
            else
            {
                int step = Int32.Parse(((Button)sender).Tag.ToString());
                next = playing + step;
                if (next < 0)
                    next = songsDataGridView.RowCount - 1;
                else if (next >= songsDataGridView.RowCount)
                    next = 0;
            }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (ee == WMPPlayState.wmppsStopped)
            {
                nextBtn.PerformClick();
            }
        ...
        private void repeatBtn_Click(object sender, EventArgs e)
        {
            ...
            if (repeat && random) randomBtn.PerformClick();
        }
        ...
        private void randomBtn_Click(object sender, EventArgs e)
        {
            ...
            if (random && repeat) repeatBtn.PerformClick();
        }
